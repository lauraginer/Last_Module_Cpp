...
/*   Updated: 2026/07/26 22:37:18 by lauragm          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "\n-- TEST 4: TESTING WITH CONST MUTANT--\n";
	std::cout << "Const mutant: \n";
	const MutantStack<int> cstack(mstack); //para comprobar que funciona con el constructor de copia
